 ...
 **Davis**, Servant, and Lee.  
 IEEE S&P 2021.  
 <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/DavisServantLee-SelectiveMemo-IEEE-SP21.pdf"><i class="fas fa-file-pdf"></i></a> <a href="https://github.com/PurdueDualityLab/memoized-regex-engine"><i class="fas fa-file-code"></i></a> <a href="https://medium.com/@davisjam/using-selective-memoization-to-defeat-regular-expression-denial-of-service-f7acbbd34792"><i class="fab fa-medium"></i></a>
...
4. *EdgeWise: A Better Stream Processing Engine for the Edge*.  
...
5. *Why Aren't Regular Expressions a Lingua Franca? An Empirical Study on the Re-use and Portability of Regular Expressions*.  
...
6. *An Empirical Study of GraphQL Schemas*.  
...
7. *Regexes are Hard: Decision-making, Difficulties, and Risks in Programming Regular Expressions*.  
...
8. *Testing Regex Generalizability And Its Implications: A Large-Scale Many-Language Measurement Study*.  
...
9. *A Sense of Time for JavaScript and Node.js: First-Class Timeouts as a Cure for Event Handler Poisoning*.  
...
10. *The Impact of Regular Expression Denial of Service (REDOS) in Practice: an Empirical Study at the Ecosystem Scale*.  
...
11. *Node.fz: Fuzzing the server-side event-driven architecture*.  
