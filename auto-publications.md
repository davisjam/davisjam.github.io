...
1. *PeaTMOSS: A Dataset and Initial Analysis of Pre-Trained Models in Open-Source Software*.  
 ...
 <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/JiangYasminJonesSynovicKuoBielanskiTianThiruvathukalDavis-PeaTMOSS-MSR24.pdf"><i class="fas fa-file-pdf"></i></a>
