...
10. *Low-Power Multi-Camera Object Re-Identication using Hierarchical Neural Networks*.  
...
11. *A Principled Approach to GraphQL Query Cost Analysis*.  
...
12. *Improving Reproducibility of Data Science Pipelines through Transparent Provenance Capture*.  
...
13. *EdgeWise: A Better Stream Processing Engine for the Edge*.  
...
14. *Why Aren't Regular Expressions a Lingua Franca? An Empirical Study on the Re-use and Portability of Regular Expressions*.  
...
15. *An Empirical Study of GraphQL Schemas*.  
...
16. *Regexes are Hard: Decision-making, Difficulties, and Risks in Programming Regular Expressions*.  
...
17. *Testing Regex Generalizability And Its Implications: A Large-Scale Many-Language Measurement Study*.  
...
2. *An Empirical Study of Artifacts and Security Practices in the Pre-trained Model Supply Chain*.  
 ...
 Proceedings of the 1st ACM Workshop on Software Supply Chain Offensive Research and Ecosystem Defenses (SCORED) 2022.  
 <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/JiangSynovicSethiIndarapuHyattSchorlemmerThiruvathukal-PTMSupplyChain-SCORED22.pdf"><i class="fas fa-file-pdf"></i></a>
