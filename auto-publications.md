...
1. <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/DavisWilliamsonLee-SenseOfTime-USENIXSecurity18.pdf"><i class="fas fa-file-pdf"></i></a>
 ...
 <a href="https://github.com/VTLeeLab/node-cure"><i class="fas fa-certificate"></i></a>
...
2. <i class="fas fa-trophy">Award</i>
 ...
 <a href="https://doi.org/10.5281/zenodo.1294300"><i class="fas fa-certificate"></i></a> **Davis**, Coghlan, Servant, Lee. *The Impact of Regular Expression Denial of Service (REDOS) in Practice: an Empirical Study at the Ecosystem Scale*. (ESEC/FSE 2018).
3. <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/DavisThekumparampilLee-NodeFz-EuroSys17.pdf"><i class="fas fa-file-pdf"></i></a>
 ...
 <a href="https://github.com/VTLeeLab/NodeFz"><i class="fas fa-certificate"></i></a> **Davis**, Thekumparampil, Lee. *Node.fz: Fuzzing the server-side event-driven architecture*. (EuroSys 2017).
