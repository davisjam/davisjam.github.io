...
8. *Reflecting on the use of the Policy-Process-Product Theory in Empirical Software Engineering*.  
 ...
 <a href="{{ site.url }}/{{ site.baseurl }}/{{ site.filesurl }}/publications/KaluSchorlemmerChenRobinsonKocinareDavis-PPPTheory-FSEIVR23.pdf"><i class="fas fa-file-pdf"></i></a> <a href="https://davisjam.medium.com/reflecting-on-the-use-of-the-policy-process-product-theory-b95c4957840c"><i class="fab fa-medium"></i></a>
