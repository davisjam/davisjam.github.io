...
<ul class="pub-list">
  ...
  <li><span class="pub-title">An Empirical Investigation of Pre-Trained Deep Learning Model Reuse in the Scientific Process</span><br><span class="venue">eScience &middot; 2026</span><br><span class="note">An early empirical look at pre-trained model reuse in the wild.</span></li>
</ul>
